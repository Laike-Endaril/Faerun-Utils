...
@Mod(modid = FaerunUtils.MODID, name = FaerunUtils.NAME, version = FaerunUtils.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.021c,)", acceptableRemoteVersions = "[1.12.2.003,1.12.2.003d]")
