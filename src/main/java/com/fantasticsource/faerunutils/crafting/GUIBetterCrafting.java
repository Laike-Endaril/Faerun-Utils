...
public class GUIBetterCrafting extends GuiContainer implements IRecipeShownListener
{
    ...
    public void initGui()
    {
        ...
        this.recipeBookGui.func_194303_a(this.width, this.height, this.mc, this.widthTooNarrow, ((ContainerBetterCraftingTable) this.inventorySlots).craftMatrix);
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (button.id == 10)
        {
            this.recipeBookGui.initVisuals(this.widthTooNarrow, ((ContainerBetterCraftingTable) this.inventorySlots).craftMatrix);
